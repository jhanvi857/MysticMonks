...
export default function CTA() {
  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      setResults(data.answer || []); // ✅ fix here
    } catch (err) {
      console.error(err);
    } finally {
      setLoading(false);
      ...
      <div className="bg-white text-gray-800">
        ...
        >
          ...
          <div className="relative z-10 text-center px-6">
            ...
            <p
              className="mt-4 text-xl md:text-2xl text-gray-200 max-w-3xl mx-auto leading-relaxed"
              data-aos="fade-up"
            >
        ...
        <section className="bg-black/10">{/* <ImageSlider/> */}</section>
        {/* Features Section */}
        <section
          className="py-16 bg-fixed flex justify-center items-center flex-col bg-cover"
          style={{
            backgroundImage:
              "url('https://www.esikkimtourism.in/wp-content/uploads/2019/04/namchimay.jpg')",
          }}
        >
            ...
            {[
              {
                ...
                desc: "Immersive panoramic monastery views.",
              },
              {
                icon: Headphones,
                title: "Narrated Walkthroughs",
                desc: "Guides in multiple languages.",
              },
              {
                icon: MapPin,
                title: "Interactive Map",
                desc: "Explore monasteries & nearby attractions.",
              },
              {
                icon: Book,
                title: "Digital Archives",
                desc: "Manuscripts, murals, and cultural records.",
              },
              {
                icon: Globe,
                title: "Smart Audio Guide",
                desc: "Works offline with location awareness.",
              },
              {
                icon: Calendar,
                title: "Cultural Calendar",
                desc: "Events, festivals, and booking options.",
              },
            ].map((feature, idx) => (
              <div
                key={idx}
        ...
        {/* CTA Section */}
        <section
          className="py-20 text-center min-h-screen bg-cover bg-fixed flex flex-col justify-center items-center bg-gradient-to-br from-yellow-500 to bg-orange-500"
          ...
          style={{
            backgroundImage:
              "url('https://i.pinimg.com/1200x/b5/02/3b/b5023be87fa1804a5bcc0c4a16b9e55b.jpg')",
          }}
        >
          <div
            className="flex justify-center flex-col items-center m-2 p-8 text-orange-500 rounded-2xl bg-white"
            data-aos="fade-up"
          >
